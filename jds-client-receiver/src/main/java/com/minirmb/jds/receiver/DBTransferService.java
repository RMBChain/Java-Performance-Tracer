...
public class DBTransferService {
	...
	@Async
	public Set<String> transfer(byte[] bs) throws IOException {
		log.info("DBTransfer starting..." + new String(bs));

		String rowString = null;
		List<SnapshotRow> snapshotRows = new ArrayList<>();
		Set<String> snapshotIdSet = new HashSet<>();
		try (StringReader sr = new StringReader(new String(bs)); BufferedReader br = new BufferedReader(sr);) {
